...
<!--        </router-link>-->
        <div class="changelog-view__container">
            ...
            <ul class="changelog-view__changeList">
                <change-log-entry :key="change.id" :actionType="change.actionType" :object1="change.object1" :object2="change.object2" :created="change.created"
